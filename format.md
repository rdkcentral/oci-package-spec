...
|                      | none                     | application/vnd.oci.empty.v1+json                                                                                                                                                                                            | _Application_<br><br> Custom package metadata provides all the information needed to run the application. The content layer references an empty descriptor and contains no actual data. The content layer file is not included in the OCI Artifact.                           |
